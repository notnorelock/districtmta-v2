-- Resolves Events/ElementData from core_shared and Logger from core via
-- the lazy-metatable pattern used across this project. Must be the first
-- server script loaded in meta.xml.
