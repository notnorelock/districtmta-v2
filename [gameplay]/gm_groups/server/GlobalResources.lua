...
-- NotificationService from core - see gm_vehicles/server/GlobalResources.lua
...
local PlayerService = {
    ...
    -- Fire-and-forget - see core/server/PlayerService.lua's own comment on
    -- why these exports take no callback (a function value can never cross
    -- the resource boundary).
    giveMoney = function(player, amount) exports.core:playerServiceGiveMoney(player, amount) end,
    takeMoney = function(player, amount) exports.core:playerServiceTakeMoney(player, amount) end,
}
