export const pl = {
  ...
  "auth.switcher.title": "Witaj ponownie!",
  "auth.switcher.savedHeading": "Twoje konta",
  "auth.switcher.savedCaption": "Zapisane konto zaloguje bez hasła. Ostatnie konto poprosi tylko o hasło.",
  "auth.switcher.recentHeading": "Ostatnio używane",
  "auth.switcher.recentHint": "Wymaga hasła",
  "auth.switcher.statusSaved": "Gotowe do logowania",
  "auth.switcher.statusRecent": "Kliknij i wpisz hasło",
  "auth.switcher.pillSaved": "Zapisane",
  "auth.switcher.pillRecent": "Hasło",
  "auth.switcher.selectAccount": "Wybierz to konto",
  "auth.switcher.removeAccount": "Usuń konto z listy",
  "auth.switcher.addNew": "Dodaj nowe konto",
  "auth.switcher.addNewHint": "Zaloguj się lub utwórz konto",
  "auth.switcher.backToSwitcher": "← Wybierz konto",
  "auth.switcher.thisDevice": "To urządzenie",
  ...
  "auth.twoFactor.title": "Weryfikacja dwuetapowa",
  "auth.twoFactor.subtitle": "Podaj kod z aplikacji uwierzytelniającej",
  "auth.twoFactor.codeLabel": "Kod",
  ...
  "auth.error.INVALID_TWO_FACTOR_CODE": "Nieprawidłowy kod",
  "auth.error.TWO_FACTOR_SESSION_EXPIRED": "Sesja logowania wygasła, zaloguj się ponownie",
  "auth.error.TWO_FACTOR_ALREADY_ENABLED": "Weryfikacja dwuetapowa jest już włączona",
  "auth.error.TWO_FACTOR_REQUIRED_FOR_ROLE": "Nie można wyłączyć weryfikacji dwuetapowej dla tej rangi",
  ...
  "dashboard.home.placeholder": "> MODUŁ W PRZYGOTOWANIU",
  "dashboard.eyebrow": "Panel gracza",
  "dashboard.settings.eyebrow": "Ustawienia systemu",
  "dashboard.account.eyebrowInfo": "Dane konta",
  "dashboard.account.eyebrowPassword": "Zmiana hasła",
  ...
  "dashboard.account.eyebrowTwoFactor": "Weryfikacja dwuetapowa",
  "dashboard.account.twoFactorEnabledStatus": "Włączona",
  "dashboard.account.twoFactorDisabledStatus": "Wyłączona",
  "dashboard.account.enableTwoFactorButton": "Włącz 2FA",
  "dashboard.account.disableTwoFactorButton": "Wyłącz 2FA",
  "dashboard.account.twoFactorSetupInstructions": "Zeskanuj kod w aplikacji uwierzytelniającej (np. Google Authenticator)",
  "dashboard.account.twoFactorSecretLabel": "Lub wpisz kod ręcznie",
  "dashboard.account.twoFactorConfirmCodeLabel": "Wpisz kod, aby potwierdzić",
  "dashboard.account.twoFactorConfirmSubmit": "Potwierdź i włącz",
  "dashboard.account.twoFactorEnabledSuccess": "Weryfikacja dwuetapowa została włączona",
  "dashboard.account.twoFactorDisablePasswordLabel": "Potwierdź hasłem",
  "dashboard.account.twoFactorDisableSubmit": "Wyłącz",
  "dashboard.account.twoFactorDisabledSuccess": "Weryfikacja dwuetapowa została wyłączona",
  "dashboard.account.twoFactorCancelSetup": "Anuluj",
