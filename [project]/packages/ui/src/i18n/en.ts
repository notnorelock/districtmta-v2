...
export const en: Record<keyof typeof pl, string> = {
  ...
  "auth.switcher.title": "Welcome back!",
  "auth.switcher.savedHeading": "Your accounts",
  "auth.switcher.savedCaption": "A saved account logs in without a password. A recent account only asks for the password.",
  "auth.switcher.recentHeading": "Recently used",
  "auth.switcher.recentHint": "Requires password",
  "auth.switcher.statusSaved": "Ready to log in",
  "auth.switcher.statusRecent": "Click and enter password",
  "auth.switcher.pillSaved": "Saved",
  "auth.switcher.pillRecent": "Password",
  "auth.switcher.selectAccount": "Select this account",
  "auth.switcher.removeAccount": "Remove account from list",
  "auth.switcher.addNew": "Add new account",
  "auth.switcher.addNewHint": "Log in or create an account",
  "auth.switcher.backToSwitcher": "← Choose account",
  "auth.switcher.thisDevice": "This device",
